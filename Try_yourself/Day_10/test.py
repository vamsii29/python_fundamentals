...
# Question_2: Population: Modify your function so it requires a third parameter,
...
class Test_city_country(unittest.TestCase):
    def testing(self):
        expected_output = city_country('santiago', 'chile')
        self.assertEqual(expected_output, 'Santiago, Chile')

    def testing_with_population(self):
        expected_output = city_country('santiago', 'chile', '5M')
        self.assertEqual(expected_output, 'Santiago, Chile, population - 5M')
